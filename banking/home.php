...
<body style="background-color:#212529;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a  href="home.php"><img src="pic/logo1.png" alt=""
            ...
            <b>
                <ul class="navbar-nav ">
                    <li class="nav-item nav-links" style="margin-left:15px;">
                        <a class="nav-link text-nowrap active" aria-current="page" href="home.php">Home</a>
                    </li>
    ...
    <div class="container-large"
        style="color:white; height:300px; width: 100%; padding:8% 2% 2% 2%; background-color:#212529;">
        
            
              <center><h1><b>Welcome to <br> Samarth
                        Bank!</b></h1></center> 
